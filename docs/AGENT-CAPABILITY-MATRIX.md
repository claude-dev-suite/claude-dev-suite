...
| **code-reviewer** | sonnet | `code-quality`, `documentation` | `security/owasp-top-10` | 16 on demand |
...
- **code-reviewer** (16) — `review/go`, `review/typescript`, `review/python`, `review/java`, `review/rust`, `review/cpp`, `review/kotlin`, `best-practices/token-optimization`, `best-practices/clean-code`, `best-practices/solid-principles`, `best-practices/git-workflow`, `best-practices/performance`, `security/owasp`, `quality/eslint`, `quality/typescript-eslint`, `frontend-frameworks/react`
