...
| **code-reviewer** | sonnet | `code-quality`, `documentation` | `security/owasp-top-10` | 10 on demand |
...
- **code-reviewer** (10) — `review/go`, `best-practices/token-optimization`, `best-practices/clean-code`, `best-practices/solid-principles`, `best-practices/git-workflow`, `best-practices/performance`, `security/owasp`, `quality/eslint`, `quality/typescript-eslint`, `frontend-frameworks/react`
