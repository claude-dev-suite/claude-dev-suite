...
| `installation/substrate.ts` | Install the shared `.claude/agents`+`.claude/skills` substrate once per install (Copilot/Cursor read it directly) — flat skills + native subagent frontmatter transform |
